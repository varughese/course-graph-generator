This parser was created by Kyle Amoroso as a part of our 1530 project major-master. You need Node 11

## `prereq-cli`

For this program to work, it uses
...
Then, cd into this directory and run the following command for info on how to use this tool.
